...
import { ArrowUpRight, MapPin, Terminal, Sparkles, Cpu } from "lucide-react";
import { useLanguage } from "../../context/LanguageContext";

const STACKS = {
  "01": ["Python", "FastAPI", "Next.js", "Tailwind CSS", "TypeScript", "Gemini", "RAG", "Agentic AI", "PostgreSQL"],
  "02": ["Next.js", "Tailwind CSS", "PHP", "Laravel", "MySQL"],
  "03": ["Python", "Django", "PostgreSQL", "Bootstrap", "jQuery"],
};
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-12 lg:px-24">
        ...
        <div className="divide-y divide-neutral-200/80 dark:border-neutral-800/80">
          {expT.experiences?.map((exp) => {
            const stack = STACKS[exp.index] || [];
